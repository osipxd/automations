...
greeting = random.choice([
    ...
    ':yawning_face: Привет всем кто уже проснулся!',
...
data = {
    ...
    "content": f'{greeting} Сегодня {day}-й день Advent of Code!\n'
               ...
               'Если задача понравилась, жми :christmas_tree:! '
               'Разберём задачи которые наберут больше всего "ёлок".\n'
               '\n'
               ...
               'Если очень хочется, окружи спойлер двумя вертикальными палками `||`, тогда текст будет скрыт (ссылки можно не скрывать за спойлеры). '
